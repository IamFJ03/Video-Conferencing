    ...
    <div>
      <div className='md:flex'>
        ...
        <div className='flex flex-col md:flex-row md:justify-center md:gap-40 mt-40 mb-20 md:mb-0 md:mt-20 md:ml-20 ml-10 md:flex-wrap gap-10'>
          ...
          <Link to={"/join-meeting"}><div className='h-50 md:min-w-70 w-70 bg-black rounded-2xl flex flex-col items-center justify-center hover:shadow-2xl hover:mt-[-20px] duration-500 hover:cursor-pointer'>
            <LogIn color='white' size={50} strokeWidth={1.5} />
            <p className='text-white text-3xl'>Join Meeting</p>
          </div></Link>
          <Link to={"/schedule"}><div className='h-50 md:min-w-70 w-70 bg-black rounded-2xl flex flex-col items-center justify-center hover:shadow-2xl md:mt-[-200px] hover:mt-[-220px] duration-500 hover:cursor-pointer'>
            <Calendar color='white' size={50} strokeWidth={1.5} />
            <p className='text-white text-3xl'>Schedules</p>
          </div></Link>
          <Link ><div className='flex flex-col h-50 md:min-w-70 w-70  bg-black rounded-2xl items-center justify-center hover:shadow-2xl md:mt-[-200px] hover:mt-[-220px] duration-500 hover:cursor-pointer'>
